...
class PasswordValidator:
    ...
    COMMON_PASSWORDS = {
        "password", "password1", "password123", "password!", "password@",
        "123456", "12345678", "123456789", "1234567", "12345",
        "qwerty", "qwerty123", "abc123", "abc123!",
        "monkey", "letmein", "letmein1", "dragon", "dragon1",
        "111111", "222222", "333333", "444444", "555555",
        "baseball", "football", "basketball", "soccer",
        "iloveyou", "trustno1", "sunshine", "princess", "admin",
        "welcome", "welcome1", "welcome123", "shadow", "shadow1",
        "ashley", "michael", "jesus", "ninja", "mustang",
        "master", "master1", "master123", "login", "login1",
        "secret", "secret1", "secret123", "test", "test1",
        "test123", "demo", "demo1", "temp", "temp1",
        "adobe123", "admin123", "photoshop", "liverpool",
        "chelsea", "arsenal", "manunited", "barcelona",
        "starwars", "starwars1", "starwars123", "harley",
        "booboo", "hottie", "tigger", "charlie", "charlie1",
        "thomas", "thomas1", "robert", "robert1", "jordan",
        "maggie", "buster", "daniel", "andrew", "andrew1",
        "joshua", "pepper", "ginger", "taylor", "amanda",
        "summer", "phoenix", "george", "oliver", "william",
        "cookie", "jasmine", "maddog", "golfer", "hunter",
        "fuckyou", "fuckyou1", "fuckyou123", "killer", "killer1",
        "flower", "slayer", "ranger", "cowboy", "cowboys",
        "matrix", "passw0rd", "p4ssword", "passw0rd1",
        "1q2w3e4r", "qazwsx", "qwertyuiop", "zaq12wsx",
        "superman", "batman", "spiderman", "ironman", "hulk",
        "mercedes", "bmw", "ferrari", "porsche", "lamborghini",
        "yankees", "redsox", "giants", "eagles", "steelers",
        "cowboys1", "raiders", "yankee", "redsox1",
    }
